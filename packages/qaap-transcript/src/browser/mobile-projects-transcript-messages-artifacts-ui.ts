...
export class MobileProjectsTranscriptMessagesArtifactsUi {
    ...
    /** Stops the shared stream-stall ticker (call when the transcript UI is torn down). */
    disposeTranscriptStreamStallWatch(): void {
        stopTranscriptStreamStallWatchExtracted(this);
    }
