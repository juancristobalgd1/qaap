...
export namespace QaapAgentPreviewChromeStyle {
    export const ROOT = 'qaap-agent-preview-chrome';
    ...
    export const HISTORY_PANEL_BODY = 'qaap-agent-preview-history-panel-body';
