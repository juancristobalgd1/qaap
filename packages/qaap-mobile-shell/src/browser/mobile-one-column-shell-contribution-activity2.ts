...
export async function activateMainPreviewWidgetExtracted(ctx: any): Promise<boolean> {
...
export async function relocatePreviewToMainIfNeededExtracted(ctx: any): Promise<void> {
...
export async function toggleMobilePreviewExtracted(ctx: any): Promise<void> {
...
export async function bootstrapMobilePreviewInBackgroundExtracted(ctx: any): Promise<void> {
        try {
...
export async function openMobilePreviewInMainExtracted(ctx: any): Promise<void> {
        try {
...
export async function ensureWelcomeInMainAreaExtracted(ctx: any): Promise<void> {
