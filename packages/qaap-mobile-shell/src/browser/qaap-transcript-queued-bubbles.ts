...
/**
 * Queued follow-ups are shown as a draggable list above the composer (see
 * `renderQueueItem` in `qaap-sticky-composer-activity-stack.ts`). They are NOT
 * duplicated as user bubbles inside the transcript anymore — the queue
