...
import { SubChatWidgetFactory } from '@theia/ai-chat-ui/lib/browser/chat-tree-view/sub-chat-widget';
...
import { QaapAgentProgressPlaceholder, QaapDelegationProgressLabel } from './qaap-shimmering-text';

@injectable()
export class QaapDelegationToolRenderer implements ChatResponsePartRenderer<ToolCallChatResponseContent> {
