...
import { resolveTranscriptSubagentCardModels } from '../common/qaap-transcript-activity-subagent-card';
import {
...
export function ensurePinnedTranscriptLiveStatusExtracted(ctx: MobileProjectsTranscriptMessagesArtifactsUiContext, conv: QaapAgentConversationDTO,
...
export function patchStreamingThoughtBriefExtracted(ctx: MobileProjectsTranscriptMessagesArtifactsUiContext, row: HTMLElement,
...
export function syncTranscriptThoughtBriefElementExtracted(ctx: MobileProjectsTranscriptMessagesArtifactsUiContext, block: HTMLElement,
    segments: readonly QaapAgentMessageSegmentDTO[],
...
export function refreshTranscriptThoughtBriefTitleExtracted(ctx: MobileProjectsTranscriptMessagesArtifactsUiContext, title: HTMLElement,
    block: HTMLElement,
    options: {
...
export function syncTranscriptActivityTimelineElementExtracted(ctx: MobileProjectsTranscriptMessagesArtifactsUiContext, timeline: HTMLElement,
