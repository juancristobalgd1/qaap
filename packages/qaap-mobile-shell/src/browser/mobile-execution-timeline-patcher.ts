...
// ─── Execution Event Timeline Patcher (mobile) ───────────────────────────────
//
// Attempts to patch an existing timeline container in place so that it matches
// the latest events, given the previously rendered events. Also handles tool
...
import { MOBILE_PROCESS_ACCORDION_CLASS } from './mobile-process-accordion';
import type {
    MobileExecutionTool,
...
import { MOBILE_EXECUTION_TIMELINE_CLASS, createMobileExecutionEventTimeline } from './qaap-execution-event-timeline';
