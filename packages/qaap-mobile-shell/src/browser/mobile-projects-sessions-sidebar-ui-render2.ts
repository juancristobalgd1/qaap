...
export function ensureWorkHubSessionsSidebarExtracted(ctx: any): MobileWorkHubSessionsSidebar {
        if (!ctx.host.sessionsSidebar) {
            ctx.host.sessionsSidebar = new MobileWorkHubSessionsSidebar({
                ...
                onExtensions: () => { void ctx.host.commands.executeCommand('workbench.view.extensions'); },
                onAutomations: () => { void ctx.onWorkHubSessionsSidebarAutomations(); },
                onResearch: () => { void ctx.onWorkHubSessionsSidebarResearch(); },
