...
/**
 * QAIQ mark — light shell around a dark terminal pane showing a cyan `>_`.
 *
 * This is the dark-background variant of the logo, so it is paired with
 * `tone: 'dark'`: the CSS backplate guarantees the dark surround the artwork was
 * drawn for, in both themes. On a light surface the shell dissolves and only a
 * floating dark pane remains.
 *
 * The source artwork styled its paths through a `<style>` block of generic
 * `.cls-N` classes; those are inlined as presentation attributes here because a
 * `<style>` element injected via innerHTML leaks document-wide and two copies
 * would fight over the same class names. Its `<title>`/`<desc>` +
 * `aria-labelledby` were dropped too — {@link uniquifySvgIds} rewrites `id` but
 * not `aria-labelledby`, so the reference would dangle. Four gradient ids
 * remain, hence the uniquify call.
 */
const SVG_QAIQ = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150 136.8" role="img" aria-hidden="true"><path fill="#C8D2CD" d="m143 24c-3.2-8.5-11.8-13.5-19.9-12.4-5.7 0.7-10.7 4.4-12.9 10.1l-0.1 0.4 26.8 17.9c5.4-3.3 7.9-10 6.1-16z"/><linearGradient id="qaiq__ear-gradient" x1="26.19" x2="26.19" y1="11.56" y2="38.91" gradientUnits="userSpaceOnUse"><stop stop-color="#E7ECE9" offset="0"/><stop stop-color="#B9C5BF" offset="1"/></linearGradient><path fill="url(#qaiq__ear-gradient)" d="m40.6 21.5c-1.8-4.3-6.6-9.9-13.9-10.1-5-0.1-10.7 1.8-14.7 6.2-4.1 5.4-5 14.7 1.8 21.3h0.2l27.4-16.6-0.8-0.8z"/><linearGradient id="qaiq__body-gradient" x1="75" x2="75" y2="136.8" gradientUnits="userSpaceOnUse"><stop stop-color="#F5F8F6" offset="0"/><stop stop-color="#D9E1DD" offset="1"/></linearGradient><path d="m146.3 64c-2.7-14.7-11-32.7-36-42.1-5.7-1.7-11.8-3.1-18.9-4-1.6-0.2-3.1-0.2-2-2.9 1-2.1 5.4-4.5 4.8-5.9-3.9-1.1-11.3 3.3-14.6 5.9-0.7 0.5-2.3 1.4-2.9 1.4 0.4-6.6 8.4-13.4 7.2-16.4-4.2-0.4-12.3 4.5-16.7 9.8s-5.6 7.1-8.6 7.8c-9.4 1.8-12.5 2.3-18 3.9-28.7 9.1-38.7 30.6-38.7 68.2-0.3 37.3 20.8 46.4 54.1 46.8 7.1 0.2 22.6 0.3 26.9 0.2 33.1-0.1 49.5-1.3 58.5-15.6 6.5-9.4 8.1-24.6 6.4-43.7-0.3-4.7-1.1-11.1-1.5-13.4z" fill="url(#qaiq__body-gradient)"/><path fill="#CCD5D1" d="m83.9 0c1 1-7.6 9.4-7.2 16.4 1.3 1.3 5.1-1.2 5.9-1.8 4.6-2.9 8.6-5.3 11.7-5.3 0.2 1.5-5.4 4.3-5.4 7 0 1.6 1.1 1.1 5.3 1.8-3.9-0.3-6.3-0.2-10.3-0.1-4.4 0.2-8.3 0.1-7.5-3.6 1.2-5.3 9.1-13.5 7.5-14.4z"/><path fill="#171918" d="m108.8 51.8c-4.7 0.2-9.1 2.4-11.9 7.8-0.9 1.6-1.2 1.7-3 1.7h-37.4c-1.1 0-1.6-0.5-2.2-1.9-2.7-5.5-7-8-13.8-7.6-9.1 0.5-27.6 6.6-29.9 29.9-1.6 17.7 2.8 31.4 13.3 38.6 8.5 5.6 18.2 7.3 34.3 7.7 10.8 0.2 21.1 0.3 33 0 21.2-0.6 48-1 48.2-38 0.1-20.6-8.8-31.4-21.1-36.4-2.6-1-6-1.8-9.5-1.8z"/><path fill="#CCD5D1" d="m83.9 0.1c-1.4-1.5-10.9 2-16.7 8.6-5.9 6.5-5.9 8.1-10.9 9.1 4.9-0.9 5.1-1 10.3-7.3 4.9-6.3 13.3-10.5 17.3-10.4z"/><linearGradient id="qaiq__terminal-gradient" x1="58.25" x2="58.25" y1="76.89" y2="109.5" gradientUnits="userSpaceOnUse"><stop stop-color="#101210" offset="0"/><stop stop-color="#1B1D1B" offset="1"/></linearGradient><path d="m58.9 89.3-19.9-11.9c-2.8-1.5-5.9 0.6-5.1 3.8 0.3 1.3 0.6 1.6 2 2.5l13.5 8.3-14.4 9.5c-1.1 0.7-2 2.6-0.9 4.7 1.4 2.8 4.4 2.7 5.8 1.6l19-11.5c1.5-0.9 2.8-2.3 2.5-4.3 0-1.1-0.8-2.1-2.5-2.7z" fill="url(#qaiq__terminal-gradient)"/><path fill="none" stroke="#47E1E0" stroke-width="6.9118" stroke-linecap="round" stroke-miterlimit="10" d="m37.2 80.6 20 12.3-20 13.6"/><path fill="#47E1E0" d="m91.7 115.1h-22.9c-1.3 0-2.5-1-2.5-2.4v-0.8c0-1.3 1.1-2.4 2.5-2.4h22.9c2.1 0 2.8 5.4 0 5.6z"/><linearGradient id="qaiq__underscore-gradient" x1="80.87" x2="80.87" y1="109.1" y2="115.6" gradientUnits="userSpaceOnUse"><stop stop-color="#1D1D1B" offset="0"/><stop stop-color="#1B1813" offset="1"/></linearGradient><path d="m92.3 109.1h-23.5c-1.4 0-2.5 1.1-2.5 2.4v0.4c0.7-1.1 1.6-1.7 2.5-1.7h22.9c1.4 0 2.4 0.9 2.6 2.4v-0.5c0.2-1.5-0.5-3-2-3z" clip-rule="evenodd" fill="url(#qaiq__underscore-gradient)" fill-rule="evenodd" opacity=".5"/></svg>`;

/**
 * OpenClaw lobster mark. Carries a gradient `id`, so it must be routed through
 * {@link uniquifySvgIds} at every render — two un-suffixed copies in one
 * document would both resolve `url(#...)` to whichever gradient came first.
 */
const SVG_OPENCLAW = `<svg viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-hidden="true"><defs><linearGradient id="openclaw__lobster-gradient" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#ff4d4d"/><stop offset="100%" stop-color="#991b1b"/></linearGradient></defs><path d="M60 10 C30 10 15 35 15 55 C15 75 30 95 45 100 L45 110 L55 110 L55 100 C55 100 60 102 65 100 L65 110 L75 110 L75 100 C90 95 105 75 105 55 C105 35 90 10 60 10Z" fill="url(#openclaw__lobster-gradient)"/><path d="M20 45 C5 40 0 50 5 60 C10 70 20 65 25 55 C28 48 25 45 20 45Z" fill="url(#openclaw__lobster-gradient)"/><path d="M100 45 C115 40 120 50 115 60 C110 70 100 65 95 55 C92 48 95 45 100 45Z" fill="url(#openclaw__lobster-gradient)"/><path d="M45 15 Q35 5 30 8" stroke="#ff4d4d" stroke-width="3" stroke-linecap="round"/><path d="M75 15 Q85 5 90 8" stroke="#ff4d4d" stroke-width="3" stroke-linecap="round"/><circle cx="45" cy="35" r="6" fill="#050810"/><circle cx="75" cy="35" r="6" fill="#050810"/><circle cx="46" cy="34" r="2.5" fill="#00e5cc"/><circle cx="76" cy="34" r="2.5" fill="#00e5cc"/></svg>`;
...
const AGENT_BRAND_FACTORIES: Record<string, () => QaapAgentBrand> = {
    ...
    openclaw: () => ({ id: 'openclaw', label: 'OpenClaw', tone: 'dark', svg: uniquifySvgIds(SVG_OPENCLAW) }),
